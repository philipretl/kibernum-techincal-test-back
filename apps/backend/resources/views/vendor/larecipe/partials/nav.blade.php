<div class="fixed pin-t pin-x z-40">
    ...
    <nav class="flex items-center justify-between text-black bg-navbar shadow-xs h-16">
        ...
        <div class="block mx-4 flex items-center">
            ...
            <larecipe-button tag="a" href="https://github.com/philipretl/kibernum-techincal-test-back" target="_blank" type="black" class="mx-2 px-4">
                Go to backend code <i class="fab fa-github"></i>
            </larecipe-button>

            <larecipe-button tag="a" href="https://github.com/philipretl/kibernum-techincal-test-frontend" target="_blank" type="info" class="mx-2 px-4">
